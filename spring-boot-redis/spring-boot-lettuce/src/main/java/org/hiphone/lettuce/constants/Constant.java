package org.hiphone.lettuce.constants;
...
public class Constant {
    ...
    public static final String SWAGGER_BASE_PACKAGE = "org.hiphone.lettuce";

    public static final String SWAGGER_TITLE = "Spring-Boot-Demo RESTful API 文档";

    public static final String SWAGGER_DESCRIPTION = "Spring boot lettuce";
